...
const LoginForm = () => {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      // Query Firestore untuk mendapatkan user berdasarkan username dan password
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen ">
      <h1 className="mt-20 mb-6 text-3xl font-bold text-center md:mt-0 md:text-5xl">
        Welcome to Perpustakaan Digital
      </h1>
      <h2 className="mb-6 text-xl font-bold text-center md:text-2xl">
        SMPN 11 Pontianak
      </h2>
      <img src={Logo} alt="logo" className="w-32 md:w-56" />
